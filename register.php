  ...
  <div class="register-box-body">
    ...
    <form id="registrarUsuario" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre y Apellido" autocomplete="off" required>
      ...
      <div class="form-group has-feedback">
        ...
        <input type="hidden" class="form-control"  name="foto" value="img-user/user.png" >
      </div>
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" required> Acepto todos los <a data-toggle="modal" data-target="#modal-info">terminos</a>
            </label>
          </div>
        </div>
        <!-- /.col -->
    ...
    <a href="../email" class="text-center">Tengo una Cuenta!</a>
  </div>
<!-- /.form-box -->
