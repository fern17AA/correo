...
<!-- Header -->
  ...
  <?php include("../componentes/menu/menu-carros.php"); ?>
 ...
 //busco la cantidad de mensajes no leidos
              $sql_numero = $db->query("SELECT * from email e inner join usuarios u on e.de = u.id  where e.para = ".$_SESSION['id']." and e.leido = 'no' ");
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="mailbox.php" class="btn btn-primary btn-block margin-bottom">Ir al Inbox</a>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                    <textarea name="mensaje" id="compose-textarea" class="form-control" style="height: 300px" placeholder="Escribe un mensaje...">
